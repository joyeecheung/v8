...
ScriptCompiler::CachedData::SanityCheckResult
ScriptCompiler::CachedData::SanityCheck(Isolate* isolate) {
  ...
  return static_cast<ScriptCompiler::CachedData::SanityCheckResult>(result);
}
