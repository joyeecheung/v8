...
class ScopeInfo : public FixedArray {
 public:
  ...
  // Does this scope contains a saved class variable (for static private
  // methods?)
  ...
  // and it has used static private methods.  Otherwise returns a value < 0.
...
#undef DECL_INDEX
  ...
  using HasSavedClassVariableField = HasClassBrandField::Next<bool, 1>;
  using HasNewTargetField = HasSavedClassVariableField::Next<bool, 1>;
 ...
 private:
  ...
  //    one slot is reserved to hold the context slot index for the class
  //    variable.
  // 4. ReceiverInfo:
