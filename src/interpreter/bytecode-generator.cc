...
bool MatchPrivateName(void* a, void* b) {
  AstRawString* x = static_cast<AstRawString*>(a);
  AstRawString* y = static_cast<AstRawString*>(b);
...
template <typename KeyT, typename PropertyT>
class AccessorTable : public base::TemplateHashMap<KeyT, Accessors<PropertyT>,
                                                   bool (*)(void*, void*),
                                                   ZoneAllocationPolicy> {
 public:
  explicit AccessorTable(Zone* zone, bool (*matcher)(void*, void*))
      : base::TemplateHashMap<KeyT, Accessors<PropertyT>,
                              bool (*)(void*, void*), ZoneAllocationPolicy>(
            matcher, ZoneAllocationPolicy(zone)),
        zone_(zone) {}

  Accessors<PropertyT>* LookupOrInsert(KeyT* key) {
  ...
  const std::vector<std::pair<KeyT*, Accessors<PropertyT>*>>&
  ordered_accessors() {
    return ordered_accessors_;
  }

 private:
  std::vector<std::pair<KeyT*, Accessors<PropertyT>*>> ordered_accessors_;
...
void BytecodeGenerator::BuildClassLiteral(ClassLiteral* expr, Register name) {
  ...
  AccessorTable<AstRawString, ClassLiteral::Property> private_accessors(
      zone(), MatchPrivateName);
  {
    RegisterAllocationScope register_scope(this);
      ...
      if (property->is_private()) {
        switch (property->kind()) {
          ...
          case ClassLiteral::Property::SETTER: {
            AstRawString* name = const_cast<AstRawString*>(
                property->private_name_var()->raw_name());
            Accessors<ClassLiteral::Property>* accessors =
                private_accessors.LookupOrInsert(name);
  ...
  if (expr->scope()->brand() != nullptr) {
    ...
    for (auto accessors : private_accessors.ordered_accessors()) {
      ...
      VisitLiteralAccessor<ClassLiteral::Property>(prototype, getter,
                                                   accessors_reg[0]);
      VisitLiteralAccessor<ClassLiteral::Property>(prototype, setter,
                                                   accessors_reg[1]);
...
void BytecodeGenerator::VisitObjectLiteral(ObjectLiteral* expr) {
  ...
  AccessorTable<Literal, ObjectLiteral::Property> accessor_table(
      zone(), Literal::Match);
  ...
  for (auto accessors : accessor_table.ordered_accessors()) {
    ...
    VisitLiteralAccessor<ObjectLiteral::Property>(
        literal, accessors.second->getter, args[2]);
    VisitLiteralAccessor<ObjectLiteral::Property>(
        literal, accessors.second->setter, args[3]);
    builder()
