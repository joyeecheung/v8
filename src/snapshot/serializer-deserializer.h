...
struct SerializeEmbedderFieldsCallback {
  SerializeEmbedderFieldsCallback(
      v8::SerializeInternalFieldsCallback js_cb = v8::SerializeInternalFieldsCallback(),
...
struct DeserializeEmbedderFieldsCallback {
  DeserializeEmbedderFieldsCallback(v8::DeserializeInternalFieldsCallback js_cb =
